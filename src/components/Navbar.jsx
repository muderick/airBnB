  ...
  return (
    ...
    >
      ...
      <div className="items-stretch self-center flex justify-between gap-5 my-auto max-md:max-w-full max-md:flex-wrap">
        <a
          href="#Homepage"
          className="text-zinc-900 font-semibold nav-link text-lg px-2"
        >
          Home
        </a>
        <a
        ...
        <a
          href="#About"
          className="text-zinc-900 nav-link text-lg px-2 font-semibold"
        >
          About Us
        </a>
        <a
        ...
        <a
          href="#ContactUs"
          className="text-orange-400 nav-link-contact text-lg px-2 font-semibold"
        >
          Contact Us
        </a>
      </div>
