...
export const Homepage = () => {
  return (
    <section
      id="Homepage"
      className="flex overflow-hidden relative flex min-h-[780px] w-full items-stretch max-md:max-w-full max-md:pl-5"
    >
      <img
          loading="lazy"
          srcSet={HomepageImg}
      ...
      <div className="absolute w-full top-0 left-0 flex justify-between">
        ...
        <div className="relative items-center bg-blue-700 flex w-[500px] max-w-full flex-col bottom-8 pl-14 pr-6 py-6 rounded-sm self-end max-md:px-5">
